...
class LocationCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        let constraint2 = NSLayoutConstraint(item: contentView, attribute: .bottom, relatedBy: .equal, toItem: addressLabel, attribute: .bottom, multiplier: 1.0, constant: 5.0)
        ...
        contentView.addConstraints([constraint1,constraint2,constraint3, constraint4])
